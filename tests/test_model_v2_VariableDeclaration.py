...
def test_variable_of_string_nullable_from_json_none(
    variable_of_string_nullable,
):
...
def test_variable_of_string_nullable_from_literal_none(
    variable_of_string_nullable,
):
    assert variable_of_string_nullable.from_literal(None) is None


def test_variable_of_string_nullable_to_literal_none(
    variable_of_string_nullable,
):
    assert variable_of_string_nullable.to_literal(None) is None


def test_variable_of_string_nullable_from_json_non_none(
    variable_of_string_nullable,
):
...
def test_variable_of_string_nullable_from_literal(variable_of_string_nullable):
    assert (
        variable_of_string_nullable.from_literal("'FromLiteral'")
        == 'FromLiteral'
    )
...
def test_variable_of_string_from_json_none(variable_of_string):
    ...
    assert str(e_info.value).startswith(
        'Cannot convert null JSON to value of VariableDeclaration(TestVariable)'
    )
...
def test_variable_of_string_to_json_none(variable_of_string):
    ...
    assert str(e_info.value).startswith(
        'Cannot convert None to JSON of VariableDeclaration(TestVariable)'
    )
...
def test_variable_of_string_from_literal_none(variable_of_string):
    ...
    assert str(e_info.value).startswith(
        'Cannot convert null URL literal to value of VariableDeclaration(TestVariable)'
    )
...
def test_variable_of_string_to_literal_none(variable_of_string):
    ...
    assert str(e_info.value).startswith(
        'Cannot convert None to URL literal of VariableDeclaration(TestVariable)'
    )
