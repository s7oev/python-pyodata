...
def service_northwind_v2(schema_northwind_v2):
    ...
    return pyodata.v2.service.Service(
        'http://not.resolvable.services.odata.org/V2/Northwind/Northwind.svc',
        schema_northwind_v2,
        requests,
    )
...
@responses.activate
def test_get_entities_with_top_and_skip_without_results_member(
    service_northwind_v2,
):
    ...
    empls = (
        service_northwind_v2.entity_sets.Employees.get_entities()
        .skip(10)
        .top(5)
        .execute()
    )
